...
- Class bytes differ because of compiler/debug/local/generic/constant-pool/lambda metadata; JAR ordering/timestamps/compression are deterministic (sorted entries, 1980 timestamp, stored entries). The artifact is not a bit-for-bit recreation of the original release.
